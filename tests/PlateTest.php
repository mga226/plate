...
class PlateTests extends PHPUnit_Framework_Testcase
{
    ...
    public function testAssociativeArrayReturnsDatasetDatapoint() {
        ...
        $dp = array('title' => 'My Title', 'content' => 'Lorem ipsum dolor');
    ...
    public function testNumericArrayReturnsLoopableDatapoint() {
        ...
        $dp = array(array('title' => 'Test Title', 'content' => 'Test Content'), array('title' => 'Test Title', 'content' => 'Test Content'));
    ...
    public function testDatasetDatapointsParseCorrectly() {
        ...
        $this->plate->setData(array('testDatasetDatapoint' => array('title' => 'Test Title', 'content' => 'Test Content')));
    ...
    public function testLoopableDatapointsParseCorrectly() {
        ...
        $this->plate->setData(array('loop' => array(array('title' => 'Test Title', 'content' => 'Test Content'), array('title' => 'Test Title', 'content' => 'Test Content'),)));
    ...
    public function testConditionalDirectiveWorks() {
        $this->plate->setData(array('title' => 'My Title', 'content' => 'My Content'));
